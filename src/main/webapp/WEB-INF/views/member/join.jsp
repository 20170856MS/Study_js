    ...
    <div class="container-fluid">
    	...
    	<div class="row justify-content-center mt-5">
        	...
        	<form action="./join.iu" method="post" enctype="multipart/form-data">
			  ...
			  <div class="row mb-3">
			    <label for="checkPassword" class="col-sm-2 col-form-label">Password</label>
			    <div class="col-sm-10">
			      <input type="password" name="password" class="form-control" id="checkPassword" placeholder="Password 재입력">
			    	<div id="pwText2"></div>
			    </div>
			  </div>
			  <div class="row mb-3">
...
<script src="/resources/images/js/join.js"></script>
</body>
</html>